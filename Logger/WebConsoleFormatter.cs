...
namespace GLOKON.GuacWS.Server.Logger
{
    internal sealed class WebConsoleFormatter : ConsoleFormatter, IDisposable
    {
        ...
        public WebConsoleFormatter(IOptionsMonitor<SimpleConsoleFormatterOptions> options)
            : base("webconsole")
        {
